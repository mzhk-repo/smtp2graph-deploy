...
2026-08-08 — Task 5.4 deploy loader now overlays a complete private names-only Docker Secret mapping over SOPS-decrypted public deployment configuration and fails closed for missing or incomplete mappings. The development service smoke remains unaccepted; no production action is implied.
