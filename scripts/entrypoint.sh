...
SMTP_ALLOWED_SENDER_ADDRESSES=${SMTP_ALLOWED_SENDER_ADDRESSES:-${GRAPH_SENDER_MAILBOX}}
...
main() {
  ...
  parse_runtime_input_file
  [ -n "${SMTP_ALLOWED_SENDER_ADDRESSES}" ] || SMTP_ALLOWED_SENDER_ADDRESSES=${GRAPH_SENDER_MAILBOX}
  validate_inputs
  require_tmpfs_dir
